...
<div class="tab-content responsive">
      ...
      ?>
        ...
        <center>
                      ...
                      if($pic1->option_picture=='' && $pic1->price_val =='X')
                        {?>
                          <a href="<?php echo $row->website_address;?>/productres/<?php echo $row->product_picture;?>"><img src ="<?php echo $row->website_address;?>/productres/<?php echo $row->product_picture ;?>" alt="<?php echo $row->website_address;?>/productres/<?php echo $row->product_picture ;?>" height="250" width="250" class="img-rounded img-responsive"  /></a>
                  <?php }
                  ...
                  ?>
                     ...
                     <a href="<?php echo $pic1->website_address;?>/productres/<?php echo $pic1->option_picture;?>"><img src ="<?php echo $pic1->website_address;?>/productres/<?php echo $pic1->option_picture ;?>" alt="No Picture" height="250" width="250" class="img-rounded img-responsive"  /></a>
                     <?php
                       }?>
                     </center>
          ...
          else
          {
              ...
              echo '<br><center>No Product Found</center>';
          }
  ...
  <div class="tab-pane responsive" id="deluxe">
      ...
      ?>
                  ...
                  ?>
                            <a href="<?php echo $pic2->website_address;?>/productres/<?php echo $pic2->option_picture;?>"><img src ="<?php echo $pic2->website_address;?>/productres/<?php echo $pic2->option_picture ;?>" alt="No Picture" height="250" width="250" class="img-rounded img-responsive"  /></a>
          ...
          else
          {
              ...
              echo '<br><center style="font-size:20px;">No Product Found</center>';
          }
      ...
      ?>
        ...
        <center>
                  ...
                  ?>
                     ...
                     <a href="<?php echo $pic3->website_address;?>/productres/<?php echo $pic3->option_picture;?>"><img src ="<?php echo $pic3->website_address;?>/productres/<?php echo $pic3->option_picture ;?>" alt="No Picture" height="250" width="250" class="img-rounded img-responsive"  /></a>
                     <?php
                       }?>
                     </center>
            ...
            <thead class="responsive">
              ...
              {?>
                 <th style="align:right;" class="bg-danger text-danger"><center>No Premuim Recipe Found</center></th>
