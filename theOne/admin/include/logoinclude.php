...
if(isset($_REQUEST['submit']) && $_REQUEST['submit'] == 'submit'){
	...
	$sql = "INSERT INTO logo (photo,catid,scatid,keyword,price,created,formated) VALUES ('$photoname','$catid','$scatid','$keyword','$price',now(),now())";
...
echo $photo;
	...
	$price=$_POST['price'];
	$sql = "UPDATE logo SET photo='$photo',catid='$catid',scatid='$scatid',keyword='$keyword',price='$price' WHERE logoid = $logoid";
