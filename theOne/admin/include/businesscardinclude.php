...
if(isset($_REQUEST['submit']) && $_REQUEST['submit'] == 'submit'){
	...
	$sql = "INSERT INTO businesscard (photo,catid,scatid,keyword,price,created,formated) VALUES ('$photoname','$catid','$scatid','$keyword','$price',now(),now())";
...
echo $photo;
	...
	$price=$_POST['price'];
	$sql = "UPDATE businesscard SET photo='$photo',catid='$catid',scatid='$scatid',keyword='$keyword',price='$price' WHERE buid = $buid";
