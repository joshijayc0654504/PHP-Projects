...
if(isset($_REQUEST['submit']) && $_REQUEST['submit'] == 'submit'){
	...
	$sql = "INSERT INTO brochure (photo,catid,scatid,keyword,price,created) VALUES ('$photoname','$catid','$scatid','$keyword','$price',now())";
...
echo $photo;
	...
	$price=$_POST['price'];
	$sql = "UPDATE brochure SET photo='$photo',catid='$catid',scatid='$scatid',keyword='$keyword',price='$price',formated=now() WHERE broid = $broid";
	...
	?>
	<?php header("Location: addbrochure.php");?>