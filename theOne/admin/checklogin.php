...
$sqlcheck = "SELECT * FROM user WHERE email like '$email' AND password like '$password' AND status = '2' AND utype='1'";
...
if($count == 1){
	...
	echo '<script language="javascript">window.location="home.php?user=wrong"</script>';
}
