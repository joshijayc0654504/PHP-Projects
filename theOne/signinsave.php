...
$query = "INSERT INTO user (fname,lname,email,password,created,status,utype) VALUES ('$fname','$lname','$email' ,'$password',now(),1,3)";
$queryExec = mysql_query($query) or die("Error in Query execution : ".mysql_error());

echo "Data inserted successfully.";
echo '<script language="javascript">window.location="front.php"</script>';
}
?>
